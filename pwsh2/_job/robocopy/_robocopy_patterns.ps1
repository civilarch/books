...
# ---------------------------------------- 
 /mt:32     By default, robocopy will use 8 threads. 
...
if destination file exists and is the same date or newer than the source 
- don't bother to overwrite it.
...
-------------------------------------------------------------------------------
  ...
  Started : Thursday, May 16, 2024 20:07:11
